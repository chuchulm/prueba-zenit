    ...
    <BrowserRouter>
      <div className="grid-container">
        ...
        <header className="rowHeader align-header">
          ...
          <div className="row">
             ...
             <div className="divLogo">
               <Link className="" to="/"><h1>PRUEBA ZENIT</h1></Link>
             </div>
        ...
        <main>
          ...
          <Route path="/search/category/:category/name/:name/min/:min/max/:max/order/:order/pageNumber/:pageNumber" exact component={SearchScreen} />
